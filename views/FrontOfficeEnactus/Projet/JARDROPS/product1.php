...
<html lang="fr">
<head>
    <title><?php echo $nomm; ?> - Enactus ICT</title>
...
<div class="menu">
    ...
    <div class="menu_nav">
        <ul>
			...
			<li><a href="index.php?ID=<?php echo $_GET['idprojet'] ?>">Acceuil</a></li>
    ...
    <header class="header">
        ...
        <div class="header_content d-flex flex-row align-items-center justify-content-start">
            ...
            <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
                ...
                <!-- Cart -->
                <div class="cart"><a href="#"><div><img src="../assets/images/cart.svg" alt="https://www.flaticon.com/authors/freepik"></div></a></div>
                <!-- Phone -->
        ...
        <div class="home">
            <div class="home_container d-flex flex-column align-items-center justify-content-end">
                <div class="home_content text-center">
                    <div class="home_title">Produit - <?php echo $nomm ?> </div>
                </div>
            </div>
        </div>
        <script>
                ...
                <div class="row" id="fahh">
                    ...
                    <div class="col-lg-6 product_col">
                        <div class="product_info">
                            <div class="product_name"><?php echo $nomm;?></div>
                        ...
                        <div class="col-lg-4 footer_col">
                            <div class="footer_about">
                                <div class="footer_logo">
                                    <a href="../../index.php">
                                        <div class="d-flex flex-row align-items-center justify-content-start">
                                        <div><img src="../../../Back Office ENACTUS/Les Modules/Gestion Projets/<?php echo $row['logo']; ?>" alt="<?php echo $row['nom']; ?>" width="300" height=auto ></div>
                                        </div>
                                    </a>
                                </div>
                            </div>
