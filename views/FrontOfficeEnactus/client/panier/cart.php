...
//if (thisdotvalue ==""){thisdotvalue=0;}
    ...
    {//alert('1');
      ...
      //**  alert(test5+' tt '+vare);
       ...
       //** if(test5==1){document.getElementById('Total_Panierez').value =vare.toFixed(3);}
       // else if (test5==1){document.getElementById('Total_Panierez').value = vare;}
      //  else{document.getElementById('Total_Panierez').value=document.getElementById('Total_Paniere').value;}
       // alert(document.getElementById('Total_Panierez').value+'  hHEHE   '+document.getElementById('Total_Paniere').value);
    }
