    ...
    <div class="menu_nav">
        <ul>
		    <li><a href="../../indexClient.php">ENACTUS ICT</a></li>
				<li><a href="./Recommandation.php?ID=<?php echo $_GET['idprojet']?> "> Acceuil</a></li>
                ...
                <div class="row" id="fahh">
                    ...
                    <div class="col-lg-6 product_col">
                        <div class="product_info">
                            <div class="product_name"><?php echo $nompr;?></div>
                            
                            <div class="product_category">Dans <a ><strong><?php echo $categorie;?></strong></a></div>
