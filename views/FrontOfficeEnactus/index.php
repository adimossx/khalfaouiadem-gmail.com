                    ...
                    <a name="ID" href="./Projet/<?php echo $row['nom']; ?>/index.php?ID=<?php echo $row['ID']; ?>"><img src="../Back Office ENACTUS/Les Modules/Gestion Projets/<?php echo $row['logo']; ?>" alt="<?php echo $row['logo']; ?>" class="image">
							<div class="overlayImage">
                                ...
                                <?php 
                                    ...
                                    {
                                    $d=strpos($string,"|");
                                    $tmp=substr($string,1,$d-1);
                                    $string=substr($string,$d+1,strlen($string));
                                    echo "<img width=\"50\" height=\"auto\" style=\"margin-top: 70%;margin-left:5%;border-radius: 100%;\" src=\"../Back Office ENACTUS/Les Modules/Gestion Projets".$tmp."\">";
                                    }
                                    ?>
							</div>
								</a>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-6">
					...
					<form name="contact" action="./Contact.php" onsubmit="" method="post">
					  <div class="form-group">
						<label >Full Name : <span> *</span></label>
						<input type="Text" required="required" class="form-control" minlength="2" maxlength="30" id="Iname" onkeyup="CheckInfoLettre(this)" name="Name" >
					  </div>
					  
					  <div class="form-group">
						<label >Email Address : <span> *</span></label>
						<input type="email" required="required" class="form-control" id="exampleInputEmail1" name="Email" onkeyup="CheckInfoEmail(this)">
					  </div>
					  
					  <div class="form-group">
						<label>Message <span> *</span></label>
						<textarea class="form-textarea" required="required" pattern="[a-zA-Z0-9éàèç\n., _-]{15,}" minlength="15" rows="3" id="IMes" onkeyup="CheckallTextArea(this)" name="Message"></textarea>
					 </div>
...
<script>
        ...
        function OkFormContact()
        {
            var nom=CheckInfoLettre(contact.Iname);
            var mail=CheckInfoEmail(contact.exampleInputEmail1);
            var mes=CheckallTextArea(contact.IMes);
            if(!nom || !mail || !mes )
            {
                return false;
            }
