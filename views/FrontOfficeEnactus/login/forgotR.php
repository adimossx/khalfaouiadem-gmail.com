                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="login">
                                ...
                                <h3 style="color:black;">Récuperation du Mot de Passe</h3>
                                <div class="form_login">
                                    <form method="POST" action="ForgotB.php" >
                                        ...
                                        <br><br>
                                        <button type="submit" name="verif_submit" value="Valider" class="btn btn-warning float_right">Envoyer !</button>
                                ...
                                <h3 style="color:black;">Votre Nouveau Mot de Passe <?php echo $_SESSION['recup_mail']; ?> </h3>
                                <div class="form_login">
                                    <form method="POST" action="ForgotB.php" >
                                        <div class="form-group">
                                        ...
                                        <br><br>
                                        <button type="submit" value="Valider" name="change_submit" class="btn btn-warning float_right">Envoyer !</button>
                                        <?php if(isset($error)) { echo '<span style="color:red">'.$error.'</span>'; } else { echo ""; } ?>
                                        </div>
