						...
						<div >
							...
							<div  >
								<form method="POST" action="supprimer_reclamation.php" id="checkout_form" >
									...
									<div class="row">
										<div > Entrez la désignation de la réclamation a supprimer (de 1 a 20 caractéres):
											<!-- Name -->
											<input value="<?PHP echo $des;?>" name="designation"  type="text" id="checkout_name" class="checkout_input"  required="required" onblur="CheckInfoDesignation(this)">
											<h6 id="msg_err_designation" style="color:red;font-size: 12px;"> </h6>
										</div>
									</div>
									<div  ><input name="valider" type = "submit" class="checkout_button trans_200" style="color:white;border:0px;background: #eb2121;" value="Supprimer"></div>
