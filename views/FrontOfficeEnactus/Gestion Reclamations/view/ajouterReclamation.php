							...
							<div class="navbar-header">
							  ...
							  <div class="collapse navbar-collapse" id="navbar">                    
									<ul class="nav navbar-nav">
                                      ...
                                      <li><a href="../../client/indexClient.php#contact" class="js-target-scroll">Contact</a></li>
			...
			<div class="profile-sidebar">
				...
				<div class="profile-usermenu">
					<ul class="nav">
						...
						<li class="active">
							<a href="afficher_reclamation.php">
					...
					<div class="cart_col">
						<form method="POST" action ="ajouter_reclamation.php" >
							<div class="cart_extra_content cart_extra_total">
								<div>
									<div  class="checkout_title">Catégorie</div>
									<div class="cart_text">
										...
										<div  >
												...
												<div class="row">
													<div class="col-lg-6" >Désignation (entre 3 et 20 léttres):
														<br>
														<!-- Name -->
														<input name="designation"  type="text" id="checkout_name" class="checkout_input" placeholder="" required="required" onblur="CheckInfoDesignation(this)">
												...
												<div class="row">
													<div class="col-lg-6">Description (maximum 200 caractéres):
														<!-- Name -->
														<textarea name="description"  type="text" id="checkout_name" class="checkout_input" placeholder="" required="required" onblur=""> </textarea>
														<h6 id="msg_err_description" style="color:red;font-size: 12px;"> </h6>
			
													</div>
												</div>
												<div  ><input value="Ajouter" name="valider" type = "submit" class="checkout_button trans_200" style="color:white;border:0px;"></div>
