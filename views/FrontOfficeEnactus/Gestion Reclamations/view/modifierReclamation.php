								...
								<div >
									<div >
										...
										<div  class="checkout_form_container">						
												...
												<div >
													<div  >Description (maximum 200 caractéres):
														<!-- Name -->
														<br>
												...
												<div ><input value="Modifier" name="valider" type = "submit" class="checkout_button trans_200" style="color:white;border:0px;background: #fcab3a;"></div>
