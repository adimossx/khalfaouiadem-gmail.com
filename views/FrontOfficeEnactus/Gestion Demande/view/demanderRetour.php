                    ...
                    <div >
                        <div  >
                            ...
                            <div  >
								...
								<div  >
									<div >Choix de l'image : <input type="file" name="choix_image" onchange=""></div>
                                
								<div >
								<select style="height:44px; text-align:center;border-radius: 3px; color:grey; " name="nomProduit" >
                                ...
                                <br>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">tapez l'ID de la commande correspondante au produit:
                                            <!-- Name -->
                                            <input name="id_commande"   type="text" id="checkout_name" class="checkout_input" placeholder="" required="required" onblur="">
