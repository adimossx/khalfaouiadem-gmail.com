								...
								<form method="POST" action="supprimer_demande.php?id_demande=<?PHP echo $_GET['id_demande'];?>" id="checkout_form" class="checkout_form">
									...
									<div class="row">
										<div >l'ID de la demande a annuler:
											<!-- Name -->
											<br>
											<input value="<?PHP echo $id_demande;?>" name="id_demande" style="width: 70%;"  type="text" id="checkout_name" class="checkout_input"  required="required" onblur="CheckInfoDesignation(this)">
