					...
					<div style="width:100%;" >
                            ...
                            <div  >
                                ...
                                <br>
                                    ...
                                    <div class="row">
                                        <div >tapez le nouveau ID de la commande correspondante au produit:
                                            <!-- Name -->
                                            <input value="<?PHP echo $_GET['id_commande'];?>" name="id_commande" style="width:70%;"  type="text" id="checkout_name" class="checkout_input" placeholder="" required="required" onblur="">
                                    ...
                                    <div  class="checkout_title">Nouvelle Déscription</div>
												<div class="row">
													<div >tapez la nouvelle Description (maximum 200 caractéres):
														<!-- Name -->
														<br>
														<textarea name="description" style="width:70%;"   type="text" id="checkout_name" class="checkout_input" placeholder="" required="required" onblur=""> </textarea>
