                                ...
                                <div class="card-body">
                                    <table class="table table-hover">
                                            ...
                                            foreach($listeListeContacts as $res){		
                                                ...
                                                echo "<td><a href=\"modifier@ListeContact.php?id=".$res['id']."&Nom=".$NomTable."&idt=".$id."\" > Modifier </a> | <a href=\"supprimer@ListeContact.php?id=".$res['id']."&Nom=".$NomTable."&idt=".$id."\" onClick=\"return confirm('Voulez vous vraiment supprimer cet élement?')\">Supprimer</a> </td>";		
                                                echo "</tr>";
                                            }
                                            ?>
                                    </table>
