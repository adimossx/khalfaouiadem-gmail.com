                                    ...
                                    <form id="BanniereAjoutForm" onsubmit="return OkForm()"  method="POST" action="ajoutBanniere.php" enctype="multipart/form-data" >
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" required="required" name="Nom_Banniere" id="INom_Banniere" placeholder="Nom de La Banniere" class="form-control" onkeyup="CheckInfoLettreChiffre(this)">
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="date" required="required" name="DateD_Banniere" id="IDateD_Banniere" class="form-control" onchange="CheckDateDebut()">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="date" required="required" name="DateF_Banniere" id="IDateF_Banniere" class="form-control"  onchange="CheckDateFin()">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" required="required" name="URL_Banniere" id="IURL_Banniere" placeholder="Lien URL" class="form-control" onkeyup="is_url(this)">
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <textarea name="Desc_Banniere" required="required" id="IDesc_Banniere" placeholder="Déscription" class="form-control" onkeyup="CheckallTextArea(this)" ></textarea>
                                            </div>
                                        </div>
