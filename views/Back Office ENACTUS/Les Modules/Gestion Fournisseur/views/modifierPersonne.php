                ...
                <div class="section-block" id="select">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body border-top">
                                          ...
                                          <form id="pers_phy_form" method="POST"  onsubmit="return verifFormFreelancer(this)">
                                            <div>
                                                <label for="inputText3" class="col-form-label">Numéro de la carte d'identité</label>
                                                <input id="Nom" name="cin" type="text" class="form-control" onblur ="CheckInfoChiffre(this)"  value="<?PHP echo $cin ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Nom</label>
                                                <input id="Nom" name="nom" type="text" class="form-control" onblur ="CheckInfoLettre(this)"  value="<?PHP echo $nom ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Prenom</label>
                                                <input id="Prenom" name="prenom" type="text" class="form-control" onblur ="CheckInfoLettre(this)"  value="<?PHP echo $prenom ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail">Adresse Mail</label>
                                                <input id="email" name="mail" type="email" placeholder="name@example.com" class="form-control" onblur="CheckInfoEmail(this)" value="<?PHP echo $mail ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText4" class="col-form-label">Téléphone </label>
                                                <input id="inputText4" name="telephone" type="text" class="form-control" placeholder="Numbers" onblur="CheckInfoNumero(this.id)" value="<?PHP echo $telephone ?>">
                                            </div>
