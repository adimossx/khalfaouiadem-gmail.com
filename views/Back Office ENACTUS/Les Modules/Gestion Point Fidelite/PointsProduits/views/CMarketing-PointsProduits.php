...
<body>
 ...
 <a href="AMarketing-PointsProduits.php"><button class="btn btn-space btn-warning"  style="float: right;" >Ajouter des points à un Produit</button></a>

 <a href="../core/Exporter.php" class="btn btn-space btn-secondary"  style="float: right; margin-right:10px " > Exporter la Liste</a>
 <br>
 <br>
<!-- ============================================================== -->
                        <!-- hoverable table -->
