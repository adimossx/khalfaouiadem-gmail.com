...
if (isset($_SESSION["login_in"])) {
    if ($_SESSION["ID"]) {
        ...
        $a1=$PointsClientsAC->a1();
        $a2=$PointsClientsAC->a2();
        $a3=$PointsClientsAC->a3();
        $a4=$PointsClientsAC->a4();
?>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Intervalle', 'Nombre'],
          ['<500',    <?php echo $a1 ?>],
          ['500< & >1000',      <?php echo $a2 ?>],
          ['1000< & >2000',  <?php echo $a3 ?>], 
          ['<2000',    <?php echo $a4 ?>]
        ]);

        var options = {
          title: 'Pourcentages sur les les points de fidélité',
          pieHole: 0.4,
        };
