...
class ClientC {
	function ajouterClient($Client){
		$sql="insert into Client (ID,pseudo,mail,Adresse,image,passwd,NumTel,nom,prenom,date,profession) values (:ID,:pseudo,:mail,:Adresse,:image,:passwd,:NumTel,:nom,:prenom,:date,:profession)";
	...
	function loginClient($mail,$mdp){
		...
		$sth = $dbh->prepare('SElECT * From client where mail=:mail and passwd=:mdp');
